...
df = pd.read_csv("data\processed_ships.csv")
...
# --- Ship table ---
ship_table = df[['ship_id','ship_name','ship_code','length','width','gross_tonnage']].drop_duplicates()
...
# --- preuredimo stolpce ---
ship_table = ship_table[['ship_id','ship_name','imo_number','mmsi','call_sign','length','width','gross_tonnage','ship_type_id']]
...
# --- Shrani CSV ---
ship_table.to_csv('data/ship.csv', index=False)
port_table.to_csv('data/port.csv', index=False)
countries_table.to_csv('data/country.csv', index=False)
cargo_table.to_csv('data/cargo_type.csv', index=False)
visit_table.to_csv('data/visit.csv', index=False)
ship_type_table.to_csv('data/ship_type.csv', index=False)
